...
sp_a1 = spin("a1", pc_defaults["a1"], 0.001, fmt="0.000")
sp_b1 = spin("b1", pc_defaults["b1"], 0.001, fmt="0.000")
sp_a2 = spin("a2", pc_defaults["a2"], 0.001, fmt="0.000")
sp_b2 = spin("b2", pc_defaults["b2"], 0.001, fmt="0.000")
